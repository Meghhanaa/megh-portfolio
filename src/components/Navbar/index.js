    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://drive.google.com/file/d/1_hX5YxO1eEPyuymO3eetWrCacSQry5I4/view?usp=drive_link" target="blank">Resume</Button>
                    <Button href="https://github.com/Meghhanaa" target="blank">Github</Button>
                    <Button href="https://www.linkedin.com/in/meghana-tamrakar-64804521b/" target="blank">LinkedIn</Button>
                </ButtonContainer>
